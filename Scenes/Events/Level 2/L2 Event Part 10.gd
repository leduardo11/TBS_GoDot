...
func move_camera():
	...
	var music_tween = BattlefieldInfo.music_player.create_tween()
	music_tween.tween_property(BattlefieldInfo.music_player.get_node("Unfufilled"), "volume_db", -80, 1.0).set_trans(Tween.TRANS_LINEAR).set_ease(Tween.EASE_IN_OUT)
